...
- **Style guide:** `/prompts/style-guide.md` (the writing bible; the only sanctioned carrier of reference-derived generic patterns)
- **Calibration manual:** `/calibration/HARNESS.md`
- ⚠️ **`/analysis/` is off-limits for this book** (blindness rules) — unlike normal production books.
