# Quit Sugar — the calibration book

**Target behavior:** refined/added sugar & junk-carb compulsion ("bad sugar")
**Status:** CALIBRATION — tuned by the auto-tuning loop (`loop/PROGRAM.md`,
North Star `docs/AUTO-TUNING-LOOP.md`)
...
only the judges see both books.

Everything here except `00-brief.md` and this README is generated
evidence, owned and overwritten by the loop. Do not hand-edit generated
artifacts — change the factory that produces them (see the tuning surface
in `loop/PROGRAM.md` §1).
