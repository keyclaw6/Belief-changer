...
- **EV-S06 — Subjective difficulty versus withdrawal**
  ...
  - **Scope:** Subjective experience with uncertain mechanism. The source reporting daily craving-management actions does not establish how long those actions continued.
  - **Permitted:** Validate difficulty without settling its cause.
  - **Prohibited:** Invent a withdrawal syndrome, call withdrawal trivial, provide a timeline, or attach a separately reported duration of more than fifteen years of maintenance to the daily craving-management actions.
...
- **EV-L07 — Relief, maintenance duration, and separately reported daily management**
  - **Tier:** `MANAGED TRUCE`
  - **Sources:** `S-021#E-001`, `S-021#E-002`, `S-021#E-004`, `S-021#E-005`, `S-021#E-006`, `S-021#E-007`, `S-021#E-008`
  - **Account:** A commercial wellness testimonial reports substantial relief. It also reports keeping weight off, more or less, for more than fifteen years. Separately, it describes daily actions to keep cravings at bay, personal boundaries, special-situation management, and resets; the source does not establish how long those actions continued.
  - **Permitted:** Honour the stated relief and use the separately reported daily actions, boundaries, special-situation management, and resets to distinguish management from absence of desire and decision tax. If the duration is mentioned for source clarity, attach it only to reported weight maintenance and never use weight as the book’s payoff.
  - **Prohibited:** Apply the more-than-fifteen-year duration to daily actions or any boundary, special-situation, or reset practice; infer program efficacy, universal maintenance needs, desire absence, or failure.
...
- **Evidence:** `EV-L05` is suppression; `EV-L07` is a commercial-testimonial managed-truce account in which relief and separately reported daily craving-management actions coexist; and `EV-L08` is one self-report only. In `EV-L07`, the more-than-fifteen-year duration belongs only to reported weight maintenance. The source establishes no duration for the daily actions, boundaries, special-situation management, or resets. These accounts illustrate distinctions, not a universal progression or book efficacy.
...
- **Guardrails:** Do not invent an author origin, success statistics, or a promise that every reader will reproduce `EV-L08`. Honour managed-truce relief, exclude weight as payoff, and never transfer the duration of reported weight maintenance to the separately reported daily management practices.
...
- **Evidence:** `EV-L05`, `EV-L06`, and `EV-L07`; preserve suppression, single-lapse, and managed-truce limits, including `EV-L07`’s separation of the maintenance duration from the undated daily practices.
...
- **Guardrails:** Do not claim abstinence universally causes obsession, mock useful boundaries, reinterpret a commercial testimonial as efficacy evidence, or imply that its daily craving-management actions continued for more than fifteen years.
...
- **Evidence:** `EV-L05` and `EV-L07` supply bounded examples of battle and management, not general fear mechanisms. Preserve `EV-L07`’s separation of the more-than-fifteen-year maintenance report from its separately reported daily craving-management actions.
...
- **Guardrails:** Fear must be dissolved, never amplified into a motive. Do not guarantee a fearless experience, imply that caution around clinical eating concerns is part of the trap, or assign a fifteen-plus-year duration to daily management.
...
- **Guardrails:** Use health information briefly, then explicitly remove fear as motive. Include the boxed `SAFE-01`/`SAFE-02` advisory. Do not create a literature-review tone in the narrative or attach the separately reported maintenance duration in `EV-S06`’s source set to daily craving-management actions.
...
- **Evidence:** `EV-L05`, `EV-L06`, `EV-L07`, `EV-L10`, `EV-L11`, `EV-L12`, `EV-L14`. Preserve suppression, single-lapse, managed-truce, early-signal, anticipated-behavior, campaign-receptivity, and non-outcome limits, including `EV-L07`’s separation of maintenance duration from undated daily actions, boundaries, special-situation management, and resets.
...
- **Guardrails:** Respect reduction and managed truce as available choices. Do not claim moderation always escalates, tapering is medically wrong, one bite restarts anything, a sugar-free product is automatically in scope, or the separately reported daily management in `EV-L07` lasted more than fifteen years. Apply `DEF-05` and `DEF-06`.
...
- **Evidence:** `EV-S01`, `EV-S06`, `EV-L15`, and `EV-L07`; preserve contested diagnosis, uncertain withdrawal, non-outcome identity language, commercial-testimonial limits, and `EV-L07`’s temporal separation.
- **Mantras:** Echo `M-01`, `M-04`, `M-05`, `M-08`.
- **Instruction:** None.
...
- **Guardrails:** Do not claim sugar creates personality traits, invoke unavailable population or genetic history, attack treatment, announce that clinical addiction is impossible, or imply that daily craving management continued for the duration reported for weight maintenance. Use the graceful concession: even if the reader retains an identity label, the benefit can still be examined.
...
- **Evidence:** `EV-L05`, `EV-L07`, and `EV-L08` may recap the outcome distinctions only; no new efficacy claim. Preserve `EV-L07`’s separation of its more-than-fifteen-year maintenance report from its separately reported daily craving-management actions.
...
- **Guardrails:** Do not manufacture certainty, shame hesitation, suggest that reluctance must be overpowered, use weight maintenance as payoff, or transfer its duration to daily management. Route each unresolved belief to its owning chapter.
...
- **Evidence:** `EV-L06` is one lapse account, not an inevitability; `EV-L05` shows desire-preserving restriction in particular accounts; `EV-L07` supplies separately reported managed-reset practices, not a universal requirement and not practices with an established duration of more than fifteen years.
...
- **Guardrails:** Never claim one bite restarts addiction or that a lapse is meaningless. Distinguish accident, honest ambiguity, lapse, and planned return without punishment. Preserve `SAFE-02` and `EV-L07`’s temporal separation.
