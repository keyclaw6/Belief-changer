...
| run-007 | 2026-07-11 | A | adversarial feedback coverage + one unchanged-loop Chapter 3 repair | Grok prerequisite uninstantiated: regional 403, no usage/content; Arm A remains frozen | preregister allowed-model fallback or close cleanly | n/a | n/a | IN PROGRESS — Opus not called | H-044 route-blocked, causal verdict pending | yes | no silent substitution; direction audit selecting minimal fallback |
