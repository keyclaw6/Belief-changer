...
| run-008 | 2026-07-11 | A | fresh-context Sol feedback + one unchanged-loop Chapter 3 repair | Opus repair frozen at 2,715 words; objective craft prediction failed; Chapters 1–2 accepted | two fresh Sol reviews + targeted Gemini evidence shadow | n/a | n/a | IN PROGRESS — no promotion possible without full gate | H-045 testing | yes | semantic result still required for causal verdict; no shared asset change |
