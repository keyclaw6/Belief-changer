...
| run-003 | 2026-07-11 | A | Chapter 2 prose-only compression | run boundary + direction audit: `GO`; inherited R3 has zero blockers | Opus prose-only Chapter 2 compression | n/a | n/a | IN PROGRESS — one-call H-040 test | H-040 | yes | no shared-asset change |
