...
| run-006 | 2026-07-11 | A | Chapter 3 whole-rewrite vs defect-scoped-edit A/B | Chapters 1–2 accepted; exact rejected R3 + review frozen | generate both Opus arms before blind Sol + Gemini reviews | n/a | n/a | IN PROGRESS — preregistered; no calls yet | H-043 testing | yes | revision scope is the only production lever; no shared asset change |
