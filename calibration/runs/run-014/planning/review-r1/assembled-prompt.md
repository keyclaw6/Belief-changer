...
These are the complete permitted inputs for one independent whole-plan outcome review. Apply the supplied frozen Master-Plan Reviewer prompt to the complete candidate plan and the six complete permitted support files. Review the whole plan for method integrity, evidence ownership, coherent architecture and budget, and H-050 composition-feasible completed value-bearing corrections. Use only the delimited bytes in this assembled prompt: do not access the filesystem, tools, network, outside knowledge, or any omitted context. Return the reviewer artifact only, following the supplied reviewer prompt exactly.
===== END OPERATOR WRAPPER =====

===== BEGIN COMPLETE FILE: prompts/master-plan-reviewer-v2.md =====
...
===== END COMPLETE FILE: prompts/master-plan-reviewer-v2.md =====

===== BEGIN COMPLETE FILE: calibration/runs/run-014/planning/master-plan-r1.md =====
...
- **Budget:** 800 words.
===== END COMPLETE FILE: calibration/runs/run-014/planning/master-plan-r1.md =====

===== BEGIN COMPLETE FILE: prompts/style-guide.md =====
...
===== END COMPLETE FILE: prompts/style-guide.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/00-brief.md =====
...
===== END COMPLETE FILE: production-books/quit-sugar/00-brief.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/framing.md =====
# Framing — Quit Sugar
...
===== END COMPLETE FILE: production-books/quit-sugar/framing.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/research/lived-experience.md =====
...
===== END COMPLETE FILE: production-books/quit-sugar/research/lived-experience.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/research/scientific-evidence.md =====
...
===== END COMPLETE FILE: production-books/quit-sugar/research/scientific-evidence.md =====
