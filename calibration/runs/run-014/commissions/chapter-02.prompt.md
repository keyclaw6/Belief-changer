===== BEGIN OPERATOR WRAPPER =====
Target chapter: CH-02. These are the complete and only permitted inputs for this commissioning task: the frozen chapter-commissioner prompt, the complete accepted canonical master plan, and the complete accepted S-010 and S-011 packets assigned to CH-02. Apply the commissioner prompt to CH-02 using only the delimited bytes below. Do not access the filesystem, tools, network, outside knowledge, or omitted context. Return only the authoritative semantic commission, or the prompt's exact blocked form if the supplied authorities cannot safely support one.
===== END OPERATOR WRAPPER =====

===== BEGIN COMPLETE FILE: prompts/chapter-commissioner.md =====
...
===== END COMPLETE FILE: prompts/chapter-commissioner.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/master-plan.md =====
...
- **Budget:** 800 words.
===== END COMPLETE FILE: production-books/quit-sugar/master-plan.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/research/sources/s-010-wic-caregiver-drink-changes.md =====
# S-010 — WIC caregiver perspectives on early-childhood beverages

- **Source ID:** S-010
- **URL:** https://doi.org/10.1007/s10995-025-04075-w
...
- **Required attribution:** Ali S, Gibbs SE, Wiseman K, Zoellner J, Montez K, Taxter A, Suarez M, Hindel L, Lewis KH; *Maternal and Child Health Journal* 29 (2025), 628–638; https://doi.org/10.1007/s10995-025-04075-w
- **Retention / deletion status:** published CC BY article; no deletion duty identified
- **Privacy judgment:** coded parent ID is retained only as the quote locator; no caregiver demographic is inferred
...
- **Locator:** Table 3, Topic 3 “Education about Healthy Drink Choices,” Parent 03
...
- **Kind:** EXACT_QUOTE
- **Text:** I started giving her water more. I started changing up her drinks. I started checking the sugars on the back.
- **Excerpt ID:** C-001
- **Locator:** Table 3, Topic 3 “Education about Healthy Drink Choices,” Parent 03
- **Persona tags:** wic-caregiver; household-change; knowledge-responsive
- **Bank slots:** Bank 5; Bank 10
- **Evidence grade:** n/a
- **Use / limits:** After WIC nutritionist advice, this caregiver reported changing a child’s drinks toward water and checking sugar labels. It does not establish the caregiver’s own abstinence or durability. The authors lightly edited all published quotations for conjunctions and colloquialisms, so this is exact to the published table, not the raw transcript.
===== END COMPLETE FILE: production-books/quit-sugar/research/sources/s-010-wic-caregiver-drink-changes.md =====

===== BEGIN COMPLETE FILE: production-books/quit-sugar/research/sources/s-011-accra-commercial-drink-avoidance.md =====
# S-011 — Sweet-beverage decisions in low-income Accra households

- **Source ID:** S-011
- **URL:** https://doi.org/10.3390/ijerph23060799
- **Title:** Factors Influencing Water and Sweet Beverage Purchasing Decisions and Behaviours Among Low-Income Households in Four Peri-Urban Communities in Accra: An Exploratory Study
- **Source type:** peer-reviewed qualitative focus-group study
- **Retrieved (UTC):** 2026-07-10T23:31:48Z
- **License / quotation basis:** CC BY 4.0, stated in the article front matter: https://creativecommons.org/licenses/by/4.0/
- **Required attribution:** Amegah C, Odei Obeng-Amoako G, Ng S, Lambon-Quayefio M, Adu-Afarwuah S; *International Journal of Environmental Research and Public Health* 23 (2026), 799; https://doi.org/10.3390/ijerph23060799
- **Retention / deletion status:** published CC BY article; no deletion duty identified
- **Privacy judgment:** participant code and community are retained only to disambiguate the locator; gender and household details are omitted to reduce indirect-identification risk
- **Disposition:** ACCEPTED
...
- **Locator:** Results §3.4.2, Person 2, Teiman
- **Capture method:** official PMC full text; rendered page verified
...
- **Kind:** EXACT_QUOTE
- **Text:** I don’t really buy any (drinks). I believe they are just made of sugar and coloring…
- **Excerpt ID:** C-001
- **Locator:** Results §3.4.2, Person 2, Teiman
- **Persona tags:** low-income-primary-shopper; commercial-drink-avoider; product-distrust
- **Bank slots:** Bank 2
- **Evidence grade:** n/a
- **Use / limits:** One shopper explained avoiding commercial sweet beverages through distrust of their ingredients. The full response reports homemade sobolo substitution, which must not be coded as sugar abstinence because the study warns that traditional drinks may contain unrecognised sugar. The published English is a checked translation from Twi or Ga.
===== END COMPLETE FILE: production-books/quit-sugar/research/sources/s-011-accra-commercial-drink-avoidance.md =====
