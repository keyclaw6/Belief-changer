...
The book factory takes any input subject and reliably produces an original, complete book that feels and works like an Allen Carr Easyway book written specifically for that subject.

## Expected result

For any subject, the factory produces a book that:

- Uses the Allen Carr belief-change method: expose the trap, dismantle the perceived benefits, remove the sense of sacrifice, and make change follow from corrected belief rather than willpower.
...
The factory succeeds when a new subject can be supplied and the resulting book is convincingly Allen-Carr-like in method, structure, voice, emotional movement, and belief-changing effect while remaining original and truthful. Scores, prompts, models, reviewers, and harness mechanisms are tools for reaching that result; none of them is the result itself.
