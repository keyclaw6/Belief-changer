...
semantic authority; resolve every ID against the plan-wide inventories), the
style guide (`prompts/style-guide.md`), and the previous chapter (for chapter
01, the plan's book-core section). Write the chapter to the path given in the
