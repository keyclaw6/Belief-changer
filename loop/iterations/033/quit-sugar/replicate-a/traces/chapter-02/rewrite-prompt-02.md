...
LENGTHEN to B±15% — Delivered 4315 words. Budget 5200. Below 0.85 x B = 4420. Add ~105-1665 words to reach 4420-5980, and use those words to serve the card's primary job: "you did not choose freely and are not weak; you were conned into a trap that removed choice" — e.g. extend the Encounter "10pm kitchen reach before decision, cupboard evidence against free-choice story."

HEADER — draft opens with the workshop header `IN THIS CHAPTER`: "**IN THIS CHAPTER** — lamplit kitchen near ten, a packet thinned to crumbs, a hand ahead of thought, sun on a step with a peach, Monday rules and Friday breakage" before spoken body. Delete that header line.
```
