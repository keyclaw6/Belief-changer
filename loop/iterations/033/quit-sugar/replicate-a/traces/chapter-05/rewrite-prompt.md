...
IN THIS CHAPTER
- The office desk at three, the top drawer and the second reach
- Tight shoes worn all day for the joy of pulling them off
- The body that already carries its own fuel
- The evening bill and the deferred load
...
Each binge re-fires the wanting and calls for the next. The wanting is not joy. The wanting is the echo of the last answer asking to be covered again.
