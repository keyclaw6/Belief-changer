...
```
REVISE
UNASSIGNED-REFRAIN — phrase "Short term lift then fast drop." recurs 3× verbatim back-to-back. Keep one instance, delete the other two; do not retain as mantra.
```
