...
IN THIS CHAPTER
— The desk at three o'clock, the drawer and the lit machine down the hall. The ring road in crawling traffic, the kitchen while tea cooks. A pair of tight sweet shoes, the morning queue, the office birthday plate.
...
```
REVISE
HEADER — the draft opens with the workshop header `IN THIS CHAPTER` — "IN THIS CHAPTER / — The desk at three o'clock, the drawer and the lit machine down the hall..." Remove the header block and open in spoken body.
```
