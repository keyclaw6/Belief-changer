...
```
REVISE
HEADER — draft opens with workshop header `IN THIS CHAPTER` after title block: "IN THIS CHAPTER / The kitchen drawer of patches and gum, the calendar crossed and recrossed..."
LENGTHEN to B±15% — Delivered 3795 words. Budget 4500. Range 3825-5175. Add 30+ words serving card job "past failures stop proving I am weak and start proving the method was wrong."
```
