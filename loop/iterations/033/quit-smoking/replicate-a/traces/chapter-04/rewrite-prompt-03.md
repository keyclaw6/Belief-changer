...
**IN THIS CHAPTER** — the ringing phone, the desk with untouched papers, the step outside, the lighter before thought, the next desk where no hand moves
...
```
REVISE
HEADER — the draft opens with the workshop header `IN THIS CHAPTER`: `**IN THIS CHAPTER** — the ringing phone, the desk with untouched papers, the step outside, the lighter before thought, the next desk where no hand moves` — remove the header opening and enter the stress-desk encounter in spoken prose.
```
