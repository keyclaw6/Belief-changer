...
```
REVISE
HEADER — draft opens with workshop header `**IN THIS CHAPTER** — a wedding table after five clean months, a pencilled diary on the kitchen counter, a small brass lamp...` Remove the IN THIS CHAPTER line and open in spoken body.
```
