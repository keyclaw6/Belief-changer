...
- redefinition / margin: none. Smoking is qu whole-modellenable as a category; no Good-X / Bad-X line, no CAPS redefinition, no dose buffer. A slip is a rumble strip for belief, never a licensed puff; guard the belief, not the behaviour with a margin.
...
I-01 — KEEP AN OPEN MIND / Give this book a fair hearing and it will free you. Owning: C01. Recap: C14.
I-02 — DON'T STOP OR CUT DOWN YET / Smoke as normal until your last cigarette. Owning: C02. Recap: C14.
I-03 — BEGIN BY FEELING GREAT TO BE ESCAPING / There is no doom here, only freedom ahead. Owning: C03. Recap: C14.
I-04 — FOLLOW ALL THE INSTRUCTIONS / All you have to do is what this book asks. Owning: C04. Recap: C14.
I-05 — IGNORE ANY ADVICE THAT CONFLICTS WITH THIS BOOK / Let this argument finish before you borrow another. Owning: C05. Recap: C14.
I-06 — DISREGARD ANYONE WHO QUIT BY WILLPOWER / Their struggle was the method, not you. Owning: C06. Recap: C14.
I-07 — REFUSE TO BE INFLUENCED BY OTHER SMOKERS / Watch them with clear eyes and keep your own judgment. Owning: C07. Recap: C14.
I-08 — TRUST YOUR BODY TO BREATHE AND TASTE / Your body knows freedom without being taught. Owning: C08. Recap: C14.
I-09 — SEE THE SELLER BEHIND THE SMOKE / Remember who built the trap and why. Owning: C09. Recap: C14.
I-10 — MEET THE BEST CIGARETTE HEAD-ON / Let the favourite prove it gives nothing. Owning: C10. Recap: C14.
I-11 — NEVER ALLOW JUST ONE OR A SPECIAL ONE / One keeps the trap alive. Owning: C11. Recap: C14.
I-12 — SMOKE YOUR FINAL CIGARETTE AND KNOW YOU ARE FREE / Close the trap with joy, not sadness. Owning: C12. Recap: C14.
...
C01 — 1 — Read This First and Be Free
...
C02 — 2 — Are You Really Choosing This
...
C03 — 3 — What Does It Actually Do For You
...
C04 — 4 — The Calm That Creates the Storm
...
C05 — 5 — Parties, Pauses and Milds
...
C06 — 6 — Why Willpower Never Worked
...
C07 — 7 — The Itch It Pretends to Scratch
...
C08 — 8 — Mornings, Meals and Breaks Without It
...
C10 — 10 — The Night Out That Proves It
...
C11 — 11 — No Special Ones, No Tomorrow
...
C13 — 13 — Mornings, Shops and Ordinary Days
