...
For every argument-bearing card, make explicit: the belief now (what is true for the reader at entry, and what this chapter makes true); the concrete subject-specific encounter; evidence IDs plus the limits the writer must not overclaim; any NEW instruction (spoken imperative only); and the reserved-later fence (work assigned only to named later chapter cards). The next argument-bearing card enters from the belief now just installed, and only from it: a card's entry belief is never a justification, relapse door, or valuation that an earlier card's enacted transition has already corrected. One correction, one card: every justification, relapse door, and false valuation the book demolishes is named in exactly one card's enacted transition, and no other card — adjacent or not — may name it in its job, the objection it resolves, its belief now, its encounter, or its structure as still open. An enacted transition that gathers several doors into one totality forecloses every door it names; a door that deserves its own chapter is left out of the totality and given to that chapter. Later cards receive a corrected belief only as one spoken sentence or its frozen token. Adjacent cards must use distinct encounters and build cumulatively rather than repeat a plan-wide inventory.
...
Arc: C01–C05 first third install world; C06–C12 middle demolish on ground with C06 inhabit primary; C13 vow last ordinary instance; C14 ordinary life; C15 short recap.
...
Concept debuts: BAD SUGAR + T-A/T-E/T-F + M-A/M-B C01; M-C/M-E/M-F/M-G + T-B C02; M-D + T-C/T-D/T-G C03; cost M-H C08; terminal M-I C13; margin T-H C10; ending reframe only C15.
...
Structural slots: redefinition decree C01; fear + anti-method + identity rooms merged C11; myths Q&A distinct room C12; meta-inoculation C12; long testimony in main flow own room C12; perception enacted C06 watch-eating + C09 tables measure; hard facts then relief C08; last ordinary sweet meal C13; ordinary life C14; short recap C15. No mid-book instruction recap assigned. No pre-endgame teaching manual assigned. Prevalence EV-11 only C08. Appendix quarantine for raw citations.
...
C02 — 2 — Caught Without Choosing
- job: enacted transition — being unable to stop proves a con not a character flaw
- resolves: I freely choose this so I am weak
- belief now: ashamed trier accepts contract but still believes choice explains persistence; encounter: kitchen late-night empty box stared at in disbelief
...
- reader-state: secret eater caught in act, encounter makes con visible without shame
...
- scene: SA-02 debut full staging; SA-04 hint reserved full C11
- guardrails: EV-02 no pathology limit; CA-A; original con image
- continuity: receives contracted investigator, hands conned not flawed investigator to C03
- budget: 4200
- new instruction: I-02 CARRY ON EXACTLY AS NORMAL FOR NOW

C03 — 3 — What Good At All
...
- belief now: conned investigator still weighs harm versus pleasure; encounter: office birthday cake weighed bite by bite
...
- continuity: receives conned investigator, hands benefit-demander to C04
- budget: 3200
- new instruction: I-03 BEGIN WITH ELATION

C04 — 4 — The Afternoon Lie
...
- belief now: benefit-demander still feels 3pm drawer proves fuel; encounter: 3pm office drawer sweet plus 4pm fog at desk
...
- reader-state: daytime yo-yoer dreading slump, encounter links lift to crash same day
- mantra: echo M-D pin "a genuine treat or lift"
- scene: SA-10 token hunger hint only, full reserved C06
- guardrails: EV-01 EV-17 safety limits; CA-A; original energy image
- continuity: receives benefit-demander, hands fuel-disillusioned to C05
- budget: 4500
- new instruction: I-04 NEVER JUDGE THE AFTERNOON BY THE LIFT

C05 — 5 — Not Love In A Wrapper
...
- belief now: fuel-disillusioned but still feels celebration needs sweet payment; encounter: small victory takeaway dessert eaten alone as self-payment
...
- reserved-later: inhabit to C06, loop to C07, engineering to C08, best scene to C09, totality to C10
...
- continuity: receives fuel-disillusioned, hands reward-disillusioned to C06
- budget: 4500
- new instruction: I-05 LET CELEBRATION PROVE ITSELF WITHOUT SUGAR

C06 — 6 — Hunger You Can Trust
...
- belief now: reward-disillusioned yet unfelt clean hunger; encounter: morning growl watched then market lunch eaten slowly to satisfaction
...
- arc: middle inhabit primary; curves: demolition pause, freedom warmth low
- reader-state: cautious taster willing to watch body, encounter makes authority felt
- mantra: echo T-F pin "Eat as much real food as you love and never count sugar again."
- scene: SA-10 debut full staging
- responsibility: inhabit-the-ordinary-doing chapter, perception enacted watch-eating
- guardrails: CA-A; no calorie / plan language; original sensory prose
- continuity: receives reward-disillusioned, hands body-grounded to C07
- budget: 4800
- new instruction: I-06 TRUST HUNGER AND EAT REAL FOOD WITH JOY

C07 — 7 — How The Low Is Made
...
- belief now: body-grounded but still puzzled why one bite becomes box; encounter: evening single biscuit followed ninety minutes later by gnaw
...
- continuity: receives body-grounded, hands loop-seer to C08
- budget: 4200
...
```
slug: quit-sugar
plan-path: production-books/quit-sugar/master-plan.md
plan-sha256: 9f4c2a7b1d3e8f05a6b7c8d9e0f1a2b3c4d5e6f708192a3b4c5d6e7f8091a2bc
F1-first-three-cumulative-walk: PASS — C01 bridge plus C02 con-proving empty-box and C03 benefit-demand birthday-cake are two enacted corrections now, not three setups
F2-whole-book-handoff-totality: PASS — C04-C12 build belief-now to belief-now with distinct encounters, justification menu mapped once each, no adjacent repeat or backward reserve, no re-opened door
F3-first-third-install-ground: BLOCK — plan | C01-C05 first-third, C06, whole-book | contract plus already-hooked plus M-E/M-F in C02 installed but body/instinct/real-food concrete SA-10 full deferred to C06 leaving only T-F slogan plus C04 token hint; finished-book risk C04-C05 demolitions float without felt ground; smallest semantic correction: move SA-10 full ownership into C02-C04 first-third and keep C06 as inhabit deepening with token-echo only
F4-mid-book-inhabit: PASS — C06 primary job inhabits hunger plus market-lunch satisfaction as favourite with SA-10 full and I-06, not a kill with inhabit flavor
F5-post-vow-life-recap: PASS — C13 last ordinary sweet meal plus vow, C14 one ordinary-life with owned thoughts once plus token-echo only, C15 2000-word photographable I-01 to I-13 recap, no second manual or new curriculum
F6-writer-facing-authority: PASS — all EV/M/T/SA/I IDs resolve with exact payloads, pinned frozen quotes, continuity plus budgets plus CA-A guardrails plus ownership present, no P-xx plus no Voice operators plus no Maya plus no ledger callbacks, M-A lettering avoids I-08 collision
F7-method-evidence-safety-originality: PASS — warm to person harsh to trap willpower-free escape-framed, EV limits plus CA-A plus fear-then-relief plus no clinical-method failure honored, original images with no libel
F8-architecture-length-spine: PASS — one belief spine with freedom crescendo plus demolition peak plus handoff, 15 positive budgets sum 3500+4200+3200+4500+4500+4800+4200+5000+4200+4300+4200+4800+2800+3800+2000=60000
needs changes first
```
