...
The Sugar Trap is not a metaphor for your appetite. Your appetite is the child with the peach. The Sugar Trap is the whole engineered loop around appetite — bright doses built to be eaten without hunger, ubiquity that puts them in every hour, talk that calls them treats and rewards and love, rules that make them glow by forbidding them, and the tiny echo after each dose that calls for the next. Each part is small. Together they close like a lid.
...
You have absolutely nothing to lose and everything to gain by looking at that pit with clear eyes for a few evenings. That is not sales talk. That is arithmetic. Looking costs nothing. The packet stays where it is. The meals stay as they are. Only the view changes, and the view is everything.
