...
IN THIS CHAPTER
The quiet table, the stained filter, the ash, the stubbed end
...
Does that read as a new chain, or as chains named one by one till the hands are empty? Would a mourner shout with joy, or would a freed prisoner? Which are you in this minute — the mourner at a grave, or the walker out of a locked room into clean morning?
