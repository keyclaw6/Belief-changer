...
IN THIS CHAPTER
The kitchen after sharp words. A phone face down. Papers on a desk. A hand finding the pack. The first draw on the back step.
...
A dose never fixed the itch of the hour. It only fed its own itch while the hour waited.
...
```
REVISE
HEADER — draft opens with workshop header `IN THIS CHAPTER` after title: "IN THIS CHAPTER / The kitchen after sharp words. A phone face down."
LENGTHEN to B±15% — Delivered 3802 words. Budget 4500. 0.85×B = 3825. Serve expanded words to card job: "stress relief stops reading as cure and starts reading as brief quiet of a need smoking created."
```
