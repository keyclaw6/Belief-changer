...
Write CH-01 — So You've Been Conned — Welcome of `production-books/quit-sugar` as the complete chapter file. Your chapter's card is the authoritative semantic authority. Resolve every ID it cites against the plan-wide inventories in the master plan. Use the immediately previous chapter only for voice continuity and the handoff seam. Do not read or seek anything beyond these four inputs.
