...
OUR CHAPTER path: /home/kab/quit-sugar-iter-020/loop/iterations/020/replicate-b/traces/chapter-13/response.md
THE REAL CHAPTER path: /home/kab/quit-sugar-iter-020/calibration/reference/gsbs/chapter-20.md
PREVIOUS CHAPTER path: /home/kab/quit-sugar-iter-020/loop/iterations/020/replicate-b/traces/chapter-12/response.md

Use this CHAPTER CONTEXT exactly (copied from the accepted plan card — do not improvise):

CHAPTER CONTEXT
Chapter 13 of 13 — C-13 — Free For Good
Primary job: non-argument — recap: photographable instruction list, outward push, saved reframe revealed.
Entering belief: NONE
Leaving belief: NONE
Arc and curve position: arc: close; freedom crescendo peak.; curve: NONE
...
- Mantras: M-A (echo): (unresolved); M-J (echo): (unresolved); M-I (echo): (unresolved)
