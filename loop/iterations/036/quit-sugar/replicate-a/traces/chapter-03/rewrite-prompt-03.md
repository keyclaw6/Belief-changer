...
HEADER — draft opens with workshop header `IN THIS CHAPTER` after title: "IN THIS CHAPTER / The wrong scales — an ordinary day on paper — teeth and the quiet bill — the empty column — the years ahead". Remove workshop header.

LENGTHEN to B±15% — Delivered 3205 words. Budget 3800. 0.85×B = 3230. Delivered is below 0.85×B. Add ~25-565 words serving card job "sugar does plenty TO you and nothing FOR you; harm debate replaced by benefit demand; the empty 'benefit' is a belief reading a tiny body echo as a gift" via the ordinary day audit encounter, not reserved-later kills.
```
