...
Eight o'clock. Low light. Programme murmurs. Old chair angled at old grazing angle. Theme tune that once cued tear and chew. Signals arrive in wave: restless hands, mouth-film memory, faint fog behind eyes, a thin low mood that says, one dose will close this and make talk easy. Old reading says, this discomfort proves need and proves both fears wise, you will fail if you sit here and you will suffer if you succeed. New reading says, dashboard again.
...
LENGTHEN to B±15% — Delivered 4258 words. Budget 5200. Range 4420-5980. Need ~200+ words net to sit inside range. Expand this undeveloped consequence belonging to this card, not a re-proof: quote to extend — "Steadiness like that, repeated across ordinary aisles and ordinary sofas, becomes the yard owned day by day, to walk steady and clear for the rest of your life as lived fact, not as theory." Extend what yard-owned steadiness does next once manufacture and ropes-belong-to-trap are already assumed: a concrete next-aisle / next-offer / next-tired-queue lived with lights-as-news, what fear-of-failing and fear-of-success lose in practical terms for mornings, work, talk, and what is gained. This must deliver new lived consequence of fear losing office and precision-machine reading, not another demonstration that labs/ads/ubiquity built want, which is already landed, and not a repeat of CH-04 willpower-collapse proof, CH-05 fuel lift-then-drop proof, or CH-06 hunger-satisfied favourite-meal inhabit in a new setting.

UNASSIGNED-REFRAIN — phrase "Old reading says," recurs 3× verbatim. Subtract repeats to <3; do not invent a new mantra.

UNASSIGNED-REFRAIN — phrase "New reading says," recurs 3× verbatim. Subtract repeats to <3; do not invent a new mantra.
```
