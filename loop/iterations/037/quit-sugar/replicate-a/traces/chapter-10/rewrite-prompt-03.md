...
IN THIS CHAPTER — Friday calendar kitchen, cliff path in sea wind, house with bare cupboards, chemist shelf, family car at the kerb
...
Read your own calendars and the verdict is plain. The rule did not tame the want. The rule fed the want. That is how the Sugar Trap oils its hinge.
...
Inside BAD SUGAR there is no neutral first bite. The first dose wakes the mouth-noise, wakes the hand-lift at old hours, wakes the timetable that points at foyer and drawer and till. Mouth films, then thirst calls for more chew to cover film. Mind argues about price and teeth while hand moves before argument closes, with wrapper rustle and regret arriving together.

We called that loss of control proof we were broken. It was proof the mechanism runs as built. Restriction-binge rhythm echoes through every diet-week we ever ran: white-knuckle days, forbidden-must-have rebound, Monday restart. The pattern lives in the rhythm, not in your character.
...
Read watched weeks and the answer shuts the haggle. One kept dose keeps the whole call alive.
...
Look at calendars kept and the trick lies bare. Tomorrow is not a date. It is a lock.
...
Read lived weeks and the shape turns. It is the other way around. The house did not hold you. The belief held the house.
...
Your own afternoons settle it. Swap the product and you remain a user, still hooked by the same timetable, still feeding the same small creature with the same belief. The substitute idea itself is the flaw.
...
Read that day whole and margin sits quiet. Accident passes when belief is guarded. Plan revives when belief is let back in.
...
Read roads driven and the answer holds. Accident passes. Plan revives. You plan none.
...
```
REVISE
HEADER — draft opens with workshop scaffolding `IN THIS CHAPTER — Friday calendar kitchen, cliff path in sea wind, house with bare cupboards, chemist shelf, family car at the kerb` before any spoken body. Delete that header line and open in spoken prose.
```
