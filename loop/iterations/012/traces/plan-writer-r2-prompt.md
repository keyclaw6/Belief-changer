...
`production-books/quit-sugar/master-plan.md` — v1.0
...
**Strongest pro-behaviour scene:** The warm, deserved celebration — cinema chocolate, family dessert on a date, "I deserve this treat after a hard day" in soft light with people you love. All the pleasure reassignable to company, occasion, relief, and rest — sugar only sneaking a ride.
...
Research units: SEU-S21, SEU-S43 | Sources: S-21, S-43 | Grade: SUPPORTED; MIXED (two grades joined)
...
*   **F-02 Nature's Guide** — positive authority + instruments: the Raw Test, the 0–20 Hunger Gauge, Primary/Secondary Foods. Debut C11. Echo C15, C17.
*   **F-03 "doing TO you vs doing FOR you"** — evaluation ledger. Debut C03. Echo C09, C10.
*   **F-04 the Willpower Method** — named anti-method (38× carrier; pushing on the hinges image). Debut C01. Owns C13. Echo C02, C06, C12, C15.
*   **F-05 the Tug-of-War** — named conflict model (both ropes held by trap). Debut C02. Owns C12. Echo C14, C15.
*   **F-06 Primary Foods / Secondary Foods** — Nature's Guide menu instruments. Debut C11. Echo C15.
...
*   **SC-09 The Optical-Illusion Tables (perception demo):** Two identical table tops where eye insists one is longer — measured proof your feelings lie. Job: hands-on demonstration that felt "benefit" is perceptual lie. Constraint: placed immediately before strongest-scene demolition.
...
*   **SC-12 The Cinema Reward Ritual:** Lights down, chocolate passed row-to-row — warmth credited to film + company, not wrapper. Job: take strongest celebration scene and strip sugar out. Constraint: second-half peak; do not moralize joy.
...
Embedded testimonial — C05 appendix; Myths Q&A battery — C06 appendix; Meta-inoculation ("is this brainwashing me?") — C11; Perception homework — C10 (illusion tables) + C11 (Raw Test); Pre-endgame knowledge recap — C13 (litany "You know that..."); Mid-book instruction recap — C09; Final recap — C17.
...
Primary job: enacted transition — "sugar is a delicious treat I deserve" collapses when credit is reassigned to occasion/company/self-kindness
Entering belief: P-03 — sugar is love/reward/taste pleasure; I'd be deprived of joy
Encounter: cinema chocolate / celebration dessert / "I've been good" evening — the strongest warmth
Discovery: isolate variable — same film, same laughter without chocolate is still warm; masking a taste vs enjoying it (reader's own behaviour as evidence); love was the company, not the dose
Emotional turn: tender nostalgia → clear-eyed recognition that sweetness was sneaking a ride
Leaving belief: the reward was not sugar; it was rest, celebration, love — sugar took the credit
Handed forward: reward-frame dismantled; taste demoted
Reserved: habit/stress myths (C06); manufacture indictment (C09)
Persona: P-03 primary, P-01 secondary
Evidence: E-L03 (verbatim quote required), E-S14 (crowding — why family size now needed; cue hyper-reactivity before bite), E-S07 (sweets predict later mood in men — scare-then-disown, with observational limit)
Scenes: SC-12 (job: reassign celebration pleasure), SC-01 echo (job: tight-shoes for reward)
Devices: credit reassignment scene, self-answered question, ventriloquism ("I deserve it," "I've been good this week")
Peak: TO/FOR verdict on reward
Scare-then-disown: yes — E-S07 delivered then disowned; do not convert to moral verdict
Structural: embedded testimonial — long-form freedom testimony (2 pages, original, per Bank 10) in chapter appendix; concrete numbers and sensory detail including authority-conflict arc
Guardrails: do not moralize sweetness as universally forbidden (E-L03 prohibited inference); preserve E-S07 men-only, observational
Budget: 3600
...
Entering belief: maybe energy/reward were illusions, but habit/stress/social/moderation remain
...
Discovery: manufacture of desire — who profits, how hook built (bliss-point, fat+sugar supra-additive seeming, appetite bypass); body's warning lights re-coded (fatigue/fog/caries are signals, not failures)
...
Handed forward: villain externalized; awe at body's sophistication seeds Nature's Guide
Reserved: strongest scene reappropriation (C10)
Persona: ALL, P-01 weighted
Evidence: E-S09 (heart/stroke/inflammation — scare-then-disown with wound-and-bandage), E-S10 (cavity mechanism), E-S14 (cue hyper-reactivity), E-S08 (WHO ceiling), plus mixed S-13/S-26 supra-additive "seems to" — preserve "seems to" hedge
...
Entering belief: "Yes but THAT dessert with THOSE people on THAT night was genuinely worth it"
...
Evidence: E-L03, E-S14 (cue fires before bite — explains why scene felt charged), E-S12 (body doesn't need it) — preserve limits
...
Scare-then-disown: no
Structural: perception homework 1 — paired sensory immersion task (recall celebration with/without sugar)
Guardrails: never concede irreplaceable benefit survives; original analogy wording
Budget: 3800
...
Scenes: SC-07 starvation re-invoke; new awe catalogue (job: make override feel vandalistic)
Devices: awe, fact-assertion, Socratic, permission paradox echo
Peak: "Your body was never fooled — only your mind was."
Structural: meta-inoculation — ventriloquize "how do I know it's not YOU brainwashing me?" and answer with counter-brainwashing + "question both sides" — placed mid-chapter; perception homework 2 — Raw Test + 0–20 Hunger Gauge trial
...
Encounter: prison-door scene (foreknowledge of freedom but fear to step) + released-convict identity analogue
...
Scenes: prison-door, released-convict (job: deconstruct both fears)
...
Evidence: lived freedom testimonies pattern (willpower wobble then stability) — Bank 10 referenced generically; E-S13 hump as explanation why willpower felt hard; preserve preliminary human limit
Mantras/tokens: echo F-04, M-07, M-05/M-06
Scenes: SC-03 hinge image — pushing on the door's hinges (Willpower Method's signature) ; SC-10 Caged Lion re-invoke
...
Scenes: SC-12 ordinary echo (coffee, commute, cinema without BAD SUGAR)
...
Instruction: full verbatim recap I-01 to I-12 with chapter cross-references (format "08. NEVER DOUBT YOUR DECISION TO QUIT. (CH15)") — licensed verbatim repetition zone
Scenes: none new
...
- **Reviewed plan:** `production-books/quit-sugar/master-plan.md` v1.0
- **Master-plan SHA-256:** `ae49414ee252393da36a8bc75fa6bbe0dcd8d4a848d3b2062c3fdb8b094bbe86`

## Cumulative reader-walk findings

- **First-three cumulative walk:** PASS — C01 completes participation now (I-01–I-03, BAD SUGAR decree, F-04 anti-method, E-S06 normalization); C02 enacts conned-not-defective choice dissolution with trap-namer debut; C03 enacts TO/FOR axis switch with empty-benefit criterion installed. Not three setup chapters.

- **Whole-book cumulative walk:** BLOCK — plan | C05, C09, C10 | C05 runs full SC-12 on cinema/celebration “strongest warmth” and leaves reward dismantled, while C09 reserves “strongest scene reappropriation” for C10 and C10 re-enters the same celebration case with SC-12 full again; finished book risks redundant re-demolition or a handoff that ignores C05’s leaving belief. Smallest fix: limit C05 to a secondary reward scene or SC-12 teaser; assign full SC-12 + SC-09 head-on solely to C10.

- **Opening persuasive work:** PASS — C01 persuades via no-risk contract, defer-quit permission, redefinition decree, and skeptical-convert frame—not merely “keep reading.”
...
- **Adjacent discovery modes:** PASS — C04–C07 vary fuel inversion, reward credit-reassignment, rationalization audit, and mechanism split without adjacent re-argument of settled cards.

- **Leaving-belief handoffs:** BLOCK — plan | C05, C10 | C05 hands forward “reward-frame dismantled; taste demoted” but C10 enters on “THAT dessert… was genuinely worth it” via the same SC-12 celebration mode without an intervening belief regression step. Smallest fix: align C05 encounter to a non-strongest reward scene so C10 inherits C09’s externalized-trap state into the reserved strongest-case job.

- **Writer-facing authority:** BLOCK — plan | C09, C11, C12, C13, C17 | **C09** cites raw `S-13` supra-additive claim with no ledger row (only E-S14 carries S-26/S-27). **C11** names Raw Test, 0–20 Hunger Gauge, and Primary/Secondary Foods plus “new awe catalogue” with no operational definitions or SC-xx bank entries. **C12** assigns prison-door and released-convict scenes absent from §4. **C13** routes SC-03 to “pushing on the door’s hinges” though SC-03 is Cliff-Jump in §4; Evidence cites “Bank 10” generically with no ledger payload. **C17** recap example misnumbers and miswords I-08 (shows “NEVER DOUBT… QUIT” vs spine’s “MAKE YOUR FINAL DOSE A SOLEMN VOW” / I-10 “ESCAPE”). Smallest fix: add ledger row or drop S-13; define instruments once under F-02/F-06; bank fear scenes as SC-13/SC-14; give F-04 hinges its own SC ID; add E-L/Bank-10 unit or remove generic cite; fix C17 to match §5 verbatim spine.

- **Other material blocker:** PASS — Carr forks explicit and brief-aligned; scare-then-disown marked on hard-evidence cards; CA-01 perimeter honored; chapter budgets sum 60,200.
