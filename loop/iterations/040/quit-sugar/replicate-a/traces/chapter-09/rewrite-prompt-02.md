...
I do not want you to act from fright at that water. Fright never kept anyone clear. I want you to see the bend so clearly that fright has no work left, only sight, and sight held in an ordinary kitchen while the kettle cools.

You will hear clever voices argue about names for all this — is it habit, is it hunger, is it something deeper. Honest answer is they argue about the label while the pattern under on-off rules is plain in your own weeks: clocked permission by day, loosened hands by night. That argument neither brands you for life nor clears the dose. It leaves you where you stand: a thinking eater who watched one pot pour two tastes and will never trust a wrapper to tell him what he likes again.
...
Hear my verdict for that table in one short line:

Crowd sang. Sugar hushed.

Keep that beside your own protected minute and the minute stays yours.
...
Hear the verdict for the offered plate in one short line:

Manners kept. Bells unfed.

Keep that beside every pushed plate and the push reads as training, not love withheld.
...
Hear the verdict for the dim pass in one short line:

Hand held. Wrapper left.

Keep that beside every protected exception and the exception turns small. Three rooms, one minute each, same shape. Table, row, till talk. Lean-in, pity, hands still, mouth talking on, feet staying, noise ending, quiet remaining. No new proof added. Corridor held as seen — gate open, pacing recognised as habit. Dashboard held as seen — belly pull honoured, mouth buzz left to thin. Aisle held as seen — bright packs recognised as build, common recognised as net thrown wide.
...
Hear the verdict for the whispers in one short line:

Voices quoted. Credit moved.

Keep that beside every I-deserve whisper and the whisper reads as script, not self.
...
Keep that beside every warning and the warning reads as method, not fate.
