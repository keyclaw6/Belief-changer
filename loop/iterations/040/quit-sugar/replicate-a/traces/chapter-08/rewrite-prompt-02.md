...
```
REVISE
UNASSIGNED-REFRAIN — "One answer fits all three." recurs 3× verbatim. Subtract repeats to at most one kept instance; do not invent a new mantra.
UNASSIGNED-REFRAIN — "Mark what did not happen." recurs 3× verbatim. Subtract repeats to at most one kept instance; do not invent a new mantra.
```
