...
**IN THIS CHAPTER** — The rinsed saucer at seven, breakfast that closes itself, the aisle without the hunt, the till and the sideways glance, supper and the sofa lamp.
...
We all knew this hour as calculation. What is allowed today. What was eaten last night. Whether Monday was clean. Whether Friday pictures may start. Whether the drawer holds a small something to get me through till lunch. The head ran numbers before the feet moved. That running was never hunger. It was the loop doing roll-call.
...
The line holds. The picture quiets when unfed and restarts when fed. Its faintness is the proof. This was never a mighty hunger demanding battle. It was a tiny loop kept loud by a large belief, and the belief went dark at the table. Hold that sight and the thought arrives pre-labelled for what it is — a dead enemy knocking, not a friend calling — and the door stays closed because you see through it, not because you lean on it.
...
Say nothing to others unless asked plainly. Preaching breeds argument and argument reopens pictures you have already closed. If someone asks why you pass the plate, answer short and warm: hunger is elsewhere, the plate is theirs with pleasure, the evening is good. Let your clear mouth and unhurried hands do the talking. Those still caught defend their picture when lectured and notice your quiet when left alone. Live the quiet. Talk of football, weather, work, children. Keep the book on its shelf, not on the table. Talk goes on around the cleared plates. Someone tells the same story twice because the middle was funny. You hear it both times to the end because nothing tugs at the sleeve to check the clock. Dishes stack in the basin. Water runs hot, then clear. Hands dry a bowl and set it down. The talk moves on — football, weather, work, children — and back to nothing in particular. You stay inside it, not above it watching yourself stay inside it.

Later a lamp clicks off in one room and on in another. Teeth brushed. Curtains drawn. Blanket turned down. No reckoning of the day. No score kept for the day. No rehearsal at the sink for tomorrow. Sleep comes in its own time, by itself, and you go when it calls. The head has no second list to run, so it stops running.

That is what the morning promised. Nothing rearranged. Same shops. Same sofa. Same people. Same hours. Only the second purpose is gone, and with it any need to stand guard or to persuade. Your business is supper, not conversion.
