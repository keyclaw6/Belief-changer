...
```
REVISE
HEADER — the draft opens with the workshop header `IN THIS CHAPTER` before spoken body: `IN THIS CHAPTER — Saturday market stalls; the kitchen table at noon; the evening table with company and the quiet kitchen after`. Cut the header block entirely; open with spoken body.
```
