...
IN THIS CHAPTER
The gate question, the ordinary table, the stain and ash, the cooling tray, the two doors, the bright reply.
...
HEADER — the draft opens with the workshop header `IN THIS CHAPTER` plus index with no spoken body: "The gate question, the ordinary table, the stain and ash, the cooling tray, the two doors, the bright reply." Remove the preview block and open in spoken voice.
```
