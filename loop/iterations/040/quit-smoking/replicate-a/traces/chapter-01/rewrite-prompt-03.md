...
Write CH-01 — Read This First and Be Free of `production-books/quit-smoking` as the complete chapter file. Your chapter's card is the authoritative semantic authority. Resolve every ID it cites against the plan-wide inventories in the master plan. Use the immediately previous chapter only for voice continuity and the handoff seam. Do not read or seek anything beyond these four inputs.
...
IN THIS CHAPTER
The stairwell, the bright phone, the airless meeting room, the coat that gives me away.
...
HEADER — the draft prints the workshop header `IN THIS CHAPTER` before spoken body: `IN THIS CHAPTER / The stairwell, the bright phone, the airless meeting room, the coat that gives me away.` Delete the header block entirely; begin with the title and spoken narrative.
```
