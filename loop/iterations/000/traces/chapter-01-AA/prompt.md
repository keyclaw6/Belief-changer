...
## User message
```
Write Chapter 01 of `production-books/quit-sugar`. Your chapter's card is the authoritative semantic authority. Resolve every ID it cites against the plan-wide inventories in the master plan. Use the immediately previous chapter only for voice continuity and the handoff seam. Do not read or seek anything beyond these four inputs.
...
### The Book Core (the plan's 'previous chapter' input for Chapter 1)
```
# BOOK CORE
**Target behavior:** Compulsive consumption of BAD SUGAR — refined/added free sugars and junk carbs (sweets, biscuits, chocolate, ice cream, sugary drinks, pastries, white bread/pasta/rice, processed snacks) taken in the craving–snacking loop. Not taste, not cooking, not nutrition pedantry.
