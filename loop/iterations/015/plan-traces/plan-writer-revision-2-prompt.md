...
Exact quotations must match the synthesis. Interpretations stay unquoted. Do not copy a full synthesis or duplicate evidence inside chapter cards. Cards cite evidence IDs only — never paste permitted, prohibited, SUPPORTED, MIXED, CONTESTED, must-state, or scope/limit workshop onto the card. The writer resolves those cells from this ledger.
...
Chapter cards reference scene/analogy IDs. A scene debuts its full staging on exactly one card; cards before that debut do not cite the ID; later cards may cite that ID only as a one-phrase token echo, never a second staging or restated full job. An argumentative job is the demolition the owning card makes true, not a new scene's label. It debuts on exactly one card; a later card must not re-own it under a new encounter or a new scene ID. Two scene IDs must not carry the same demolition. They never copy the full scene or analogy into the card.
...
Define each numbered instruction once with a stable ID, frozen wording, owning chapter, and recap placement. Frozen instruction wording is the spoken Carr ALL-CAPS headline only. Do not freeze a second slogan or scene punchline (safe/combination lock, "miss one number") onto the spine row. A spoken clause in the owning chapter is writer execution, not a second frozen token. Never fuse clinical disclaimers, liability tails, semicolon-chained compliance clauses, or instruction-ID cross-references (e.g. "as in I-05") into instruction spine rows.
...
For every argument-bearing card, make explicit: the belief now (what is true for the reader at entry, and what this chapter makes true); the concrete subject-specific encounter; evidence-ledger IDs only; any NEW instruction (spoken ALL-CAPS headline only); and the reserved-later fence (work assigned only to named later chapter cards — a reserved job is not a later restage of a debuted demolition). The next argument-bearing card enters from the belief now just installed. Adjacent cards must use distinct encounters and build cumulatively rather than repeat a plan-wide inventory. The job that debuts is what this chapter makes true. A later card must not make that same demolition true again under a new encounter or a new scene ID; it may name the already-true picture in one breath.
...
- for every argument-bearing card: belief now, concrete subject-specific encounter, evidence-ledger IDs only (limits stay in the ledger — never permitted/prohibited/SUPPORTED/must-state paste), any NEW instruction (spoken ALL-CAPS headline only — CA-01), and the reserved-later fence;
...
- mantra and frozen-token IDs only when this chapter debuts or naturally echoes one: debut pins exact wording once in plain text; echo cites the lettered ID only — never markdown backticks, never a list of frozen quotes;
- one or more concrete scene/analogy IDs: debut card carries the staging job; later cards that cite the ID mark it as token-echo only — never a new scene ID or a new encounter whose work is a demolition a prior card already made true;
- structural responsibility, if any;
- method, safety, and originality guardrails specific to this move (safety-limit IDs and originality only — never speakable register/job operators, never a boxed CA-SAFE/CA-01 title, never "Socratic trap question" or other device names, never "use SUPPORTED limits" as a card instruction);
...
- repeated full instruction, evidence-row paste (permitted/prohibited/SUPPORTED/must-state), or slot text in chapter cards (debut pinned quotes in plain text are the exception; echo cards cite ID only; never markdown backticks);
...
- Job: Strongest-case head-on demolition; reassigns all warmth to people/moment/body, exposing sugar as sneaking a ride.
...
- reserved later: Axis-switch verdict (C-03), benefit demolitions (C-04–C-06), mechanism deepening (C-07), villain engineering (C-08), strongest case (C-09), inhabit (C-10), escape-route foreclosure (C-11)
...
- reserved later: Individual benefit demolitions (C-04–C-06), inversion mechanism (C-07), villain detail (C-08)
...
- structural responsibility: Axis-switch chapter; justification menu printed verbatim here as quoted reader lines (treat, fuel, reward, social, harmless) — thereafter demolished one by one, not one chapter per justification.
...
- evidence: E-15, E-08
- new instruction: none
- reserved later: Fuel lie (C-05), reward lie (C-06), mechanism (C-07), industry (C-08)
...
- new instruction: none
- reserved later: Reward/ coping demolition (C-06), deep mechanism (C-07)
...
- primary job: enacted transition — sugar as reward/love/self-care becomes less credible as you see you are paying the confection with your own virtue
- objection resolved: "I deserve it. It's my treat, my comfort, my de-stress."
- belief now: Entered seeing sugar as affection earned; leaves seeing reward-frame keeps loop alive and leaves them tired, wired and craving.
- encounter: Cinema, celebration, hard-day kitchen — the deserve-it moment replayed without sugar, warmth intact.
- evidence: E-17, E-09, E-01
- new instruction: none
- reserved later: Mechanism deepening, villain, strongest case
- arc position: middle — demolish — peak
- reader state: Comfort-seeker who loves the earned sweet — moved by re-seeing love belongs to people and rest, not the dose.
- mantra: echo M-D, M-I
- analogy: none new (credit-reassignment scene does work)
- structural responsibility: Benefit demolition; completes justification kills before mechanism deepening.
- guardrails: Validate feeling first; never moralize sweetness universally (GOOD SUGAR remains).
- continuity: Hands to C-07 with all major benefits reassigned.
- words: 4000
...
- new instruction: none
- reserved later: Who engineered desire (C-08), strongest-case reassign (C-09), inhabit (C-10), escape-route foreclosure (C-11), fear/anti-method (C-12–13)
...
- new instruction: none
- reserved later: Strongest case, inhabit, foreclosure, fear/identity
...
- primary job: enacted transition — the single most seductive sugar scene keeping its pleasure with sugar becomes incredible once every drop of warmth is reassigned to people, moment, and body
- objection resolved: "But the birthday / the cinema / the celebration — that joy is real."
- belief now: Entered with one cherished exception still alive; leaves seeing the exception was the best ride sugar ever sneaked.
- encounter: Full staging of birthday cake alight while friends sing, cinema chocolate passed hand to hand, 3pm office drawer — replayed without BAD SUGAR, joy undiminished.
- evidence: E-17, E-11, E-02, E-18
- new instruction: none
- reserved later: Inhabit (C-10), foreclosure (C-11), fear/identity (C-12–13)
- arc position: middle — strongest case — freedom rising
- reader state: Celebrant protecting a memory — moved by re-inhabiting it and finding sugar added nothing. Encounter: living the same celebration with taste and laughter intact.
- mantra: echo M-D, M-H
- analogy: debut A-08 Birthday Cinema full staging; debut A-09 Optical-Illusion Tables full staging (perception-enacted exercise)
- structural responsibility: Strongest-case head-on chapter + embedded long-form freedom testimony (1–2 pages, original, concrete numbers/sensory detail, drawn from E-18, in its own room — not a labelled appendix) + one perception-enacted exercise.
- guardrails: Never shame celebration; honour GOOD SUGAR boundary; original scene prose.
- continuity: Hands to inhabit chapter with seductive case closed.
- words: 3800
...
- **plan_sha256:** `40c41ca586e761b069dcc147f702fb27d433ee7fc7465e3df97b38fed7297014`

## Findings

**first_three_cumulative_walk:** PASS — C-01 installs contract, BAD SUGAR decree, M-A/M-B, and I-01–I-04 now. C-02 persuades now (conned-not-free-choice, Sugar Trap, Nibbler/Big Confection, sensory phrase, body/instinct/real-food encounters, E-01/E-07). C-03 enacts TO/FOR axis switch with T-A, M-D, and E-10/E-12 now — not three deferred-setup chapters.

**whole_book_cumulative_walk:** BLOCK — plan | C-06, C-09 | C-06 already replays cinema/celebration without sugar and hands all major benefits reassigned; C-09 then enters with “one cherished exception still alive” and full-stages birthday/cinema/3pm under A-08 — restaging settled demolition work and breaking the belief handoff. Finished book risks repeating the same seductive scenes instead of building forward. Smallest fix: revise C-09 entry belief to match C-06–C-08 continuity; limit A-08 to net-new birthday full staging with cinema/3pm as one-phrase token echoes only.

**writer_facing_authority:** BLOCK — plan | C-03 | C-03 prints a five-line justification menu (treat, fuel, reward, social, harmless) but no card owns **social** demolition — only treat/fuel/reward map to C-04–C-06; harmless is settled in C-03, social is orphaned. Writer cannot resolve work ownership from the card alone. Smallest fix: assign social to one card’s primary job (e.g. fold into C-09 encounter/objection or add explicit ownership on C-06/C-11).

**method_evidence_safety_originality:** PASS — Carr forks locked; warm-to-reader/harsh-to-trap; willpower-free; hard facts in C-03 close on escape; CA-SAFE boxed and guardrailed; E-06/E-11/E-14 limits honoured on citing cards; margin-for-error present; original Nibbler/Big Confection and scene bank.

**architecture_and_length:** PASS — 16 chapters; budgets sum 61,500; first third installs contract, hooked-trap, creatures, body/real-food ground by C-02; C-10 inhabit-primary; post-vow spine C-14 ritual / C-15 ordinary life / C-16 short recap; prevalence once C-02; saved reframe A-06 C-14/C-16 only.

**gate_4_speakable_card_sanitization:** PASS — No P-xx codes, named pupil handles, Voice operators, unspeakable beat labels, boxed CA-SAFE paste instructions, chapter-number callbacks, permitted/prohibited cells, or backtick frozen tokens on cards; mantra letters avoid I-number collision; instructions are bare ALL-CAPS imperatives.

**brief_alignment:** PASS — Target behavior, reader, scope/non-goals, and load-bearing false belief match `00-brief.md`; all five forks decided in plan §1.

**research_ledger_alignment:** PASS — Every card-cited E-ID resolves in §2 with grade, limits, and permitted/prohibited inference; E-18 traces Bank-10 testimony for C-09 embedded arc.
