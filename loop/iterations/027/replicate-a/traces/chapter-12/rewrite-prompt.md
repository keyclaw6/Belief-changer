...
```
REVISE
LENGTHEN to B±15% — Delivered 2798 words is below 0.85 x B (0.85 x 4200 = 3570). Lengthen to 3570-4830 range.
MANTRA — card-assigned "the Nibbler" not present verbatim. Draft has only "The Nibbler" with capital T, no exact "the Nibbler".
```
