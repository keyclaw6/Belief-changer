...
IN THIS CHAPTER – The corner meter, a pocket of coins, a day of fading doses, the itch under the skin, the smoker at the next table
...
That sentence sounds too large only while the Smokescreen is speaking. Look at the table again. Chained to a post, feeding it coins all day, calling each coin a little party. Is that a man to envy? Would you envy a man scratching a rash he pays to keep?
...
That is the whole mechanism, seen without paint. A small physical fade, misread by a large implanted belief, topped up twenty times a day until topping up looked like living. Starve the small fade and it passes. Clear the large belief and there is nothing left to feed.

7. REFUSE TO BE INFLUENCED BY OTHER SMOKERS
Watch them with clear eyes and keep your own judgment.

**SUMMARY**
- Each dose pushes a fading level up for minutes, then the level sinks again, so the hand must dose all day to chase its own tail.
- The small restless tug is a passing physical signal with a short typical peak, not proof the dose helped and not proof of who you are.
- Other smokers show the same timetable at work, a brief settle followed by the same reach, not enjoyment to borrow.
- The quiet from a cigarette is a brief return toward where non-smokers stand all day, and that return guarantees the next dip.
```
