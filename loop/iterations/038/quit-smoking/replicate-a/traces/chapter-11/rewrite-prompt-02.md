...
I had gone five months without a puff. Not five hours. Five months. Mornings to the kettle without lighting. Meals finished and taste lingering. Breaks with hands full of other things. The empty, slightly edgy tug had gone quiet long before. I thought of myself as clear.
...
You know the honest answers because your own hand wrote them. No special paper is mild. No small number is safe. Both keep the Nipper fed on a shorter leash, and a fed Nipper always pulls for more, leaving you glad to be free of counting at last.
...
We say it to sound kind to ourselves. The Smokescreen loves that kindness because it costs the trap nothing and buys it everything.
...
```
REVISE
LENGTHEN to B±15% — Delivered 2790 words. Budget 3500. Range required 2975-4025 (0.85xB=2975). Need +185 minimum, ~700 to centre.

Expansion assignment: Extend the undeveloped consequence of a guarded slip belonging to this card's E-06 limit, not another proof that one is unsafe.

Quote draft location to extend: "Guard the belief now and the slip stays a lesson. Let the belief back in and repeat the dosing and the chain rebuilds. Learn, do not mourn."

What is unfinished: the draft lands that one rebuilds the chain and that doom is not entailed, but never lives the next hours after the wedding-morning slip with belief guarded — what the smoker does, thinks, and feels when the sour mouth is read as rumble-strip steering back to sight rather than as license to keep dosing.

What the extension must deliver: lived consequence of the warning used correctly — how staying smoke-free after the warning differs in thought and action from the climb back to a pack by Friday, delivering the understanding that the lesson holds freedom without mourning. Check: no earlier card owns slip-handling; C04 stress-desk, C05 reward, C07 itch, C10 patio are already landed in this draft as one-rebuilds / cutting-down fails / tomorrow charges — do not re-prove those conclusions in a new setting and do not add another tomorrow-date or another cut-down diary proving the same verdict. Extend only this card's five-months encounter forward with the settled understanding assumed.
```
