...
**IN THIS CHAPTER**
A ringing phone after a sharp row, a desk of papers that wait, a hand that moves before thought, a lit end burning while nothing gets settled
...
I know that sentence from the inside. I lived inside it for years. The phone slams. The voice on the other end leaves a sting in your ear. Bills spread. A child's school letter. A sharp word with the woman you love. The shoulders climb toward your ears. The stomach knots. And the hand is already moving to the pocket before you have chosen.
...
Keep your packet where it is. I am not asking you to act different. I am asking you to watch with a witness's eyes what that minute does and what it leaves untouched.
...
That short rise and short fade is not a gift that sorts life. It is replenishment. The Nipper, that tiny physical whine we all feed, quiets briefly when fed and then whines again. The quiet feels like the row easing because the two discomforts arrived together.
...
If the dose steadied nerves, why do the heaviest smokers shake most when the packet runs low? If the dose cleared thought, why does thought return clearest after the stub, when the head clears? If the dose handled strain, why does the same strain return an hour later with an extra tug laid over it?
...
### YOU DO NOT HAVE TO PROVE THIS BY STRAIN

I know this is hard to accept at first. A lifetime of credit does not move in one minute.

You do not have to test it by white knuckles or by watching every puff like a laboratory. You do not have to argue with the hand when it moves. We are studying, not fighting. Keep smoking as normal while we look. Only keep watching the order: strain untouched, tug quieted, tug returned.
...
- The tightness that eased for seconds returned with the same weight, plus a stale mouth and lost minutes.
- The non-smoker meets the same strain with frown, pause, and breath, and picks up the next paper without a tube.
- Watching the order is enough; the desk proves the dose never handled strain.
```
