...
If you feel flat, doubtful, or heavy — if some bright exception still glows in your mind as love or comfort or fuel — do not push through on nerve. Put this chapter down. Go back and re-read the rooms where the glow lived. Look again at the cinema warmth that belonged to faces, not foil. Look again at the desk at three where the lift made the low. Look again at the Friday that ate the week. Come back when the lift returns. It will return quickly, because truth once seen will not stay hidden.
...
Open it slowly. Smell it. Notice how loud the paper is, how fast the hand moves, how the mouth waters before the bite from old training. Take the bite normally. Chew. Do not rush to judge. Do not hunt for pleasure or for disgust. Simply notice.
...
Sit with the cup or wrapper in your hand. Feel belly tight, mouth dry, head a fraction thick behind the eyes. Feel the flat, faint restlessness underneath the glow asking for more to keep the glow alive. That is the dose doing its work. Blaze, then weight. Lift that digs its own low.
...
Do you see how light this is? No clocks. No counts. No watching the door like a prisoner begging to stay when the door stands wide open. That old pacing by the bars was cage-habit, not need. Habit fades in open air. Walk the green field. Eat hungry. Leave food at satisfied. Pass bright shelves the way eyes pass goods for another household. Sit on the sofa with hands quiet and talk whole. Sleep clean and wake clear.
...
```
REVISE
HEADER — draft opens with the workshop header `IN THIS CHAPTER` after the title, followed by scene-setting lines.
LENGTHEN to 3600±15% — Delivered 2634 words is below 0.85 × 3600 = 3060.
MANTRA — card-assigned M-A `"you have absolutely nothing to lose and everything to gain"` not present verbatim; draft has `You have absolutely nothing to lose and everything to gain` with capital Y.
```
