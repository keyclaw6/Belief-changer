...
Welcome back, clear eater. You split the craving in two and the split holds.
...
And here is the inversion the Con hides: the shared signs are made by the loop, not by shared blood. The evening loss of control. The short term lift then fast drop. The creeping size, where a small bar once did and now the family pack barely touches the sides. The wrapper rustle across the room firing want before the bite. The three o’clock hour striking like a bell. Put different families, different streets, different tempers into the same schedule of dose and gap and dose, and the same signs bloom. In rats given sweet in bursts with gaps, the same pattern shows — binge, chase, dip, cue answer — which tells us schedule plus sweet can drive the dance. That is animal work, a hint about form, never proof of anything fated in you. In you the proof is lived, not labbed. You lived the creep. You lived the bell.
...
Look at your own week with clear eyes. You are steady with bread and soup and fruit. You stop mid-meal when satisfied without counting or struggle. You forget food for hours when living fully. Where is the addictive type then? It appears only where BAD SUGAR appears — at the bright packet, at the old hour, at the tired evening. A type that vanishes at the market and appears at the checkout is not a type. It is a cue answering a dose.

You say, “But my family—” I answer gently. Families share cupboards before they share character. Kind mothers who were conned stock what bright voices called love. Children raised by the same shelf reach for the same shelf. That is teaching, not blood. Put a clear child from a grazing house into a clear kitchen for a month and watch the tooth ache fade. Put a clear child from a clear kitchen into a grazing house and watch the tooth appear. The tooth is taught. What is taught can be untaught by seeing.

You say, “But stress—” I answer from life. BAD SUGAR never removed the bill, the row, the deadline. It paused attention for minutes while adding fog and twitch that made the load heavier to lift after. You called the pause relief. The pause was a hole with a hand. The ditch-digger smiled again.
...
That is the second rope. Fear of succeeding. It sounds like identity. “Who am I at birthdays without the bright parcel? What do I reach for when tired? Will evenings feel strange? Will I be dull?” The Sweet Con paints clear life as grey and calls the paint prophecy. So you mourn a future you have not lived, missing a master you have not yet left.

I want you to see both ropes in one glance, because one glance dissolves both. The prisoner and the lion are held by nothing present. One is held by memory of walls. One is held by habit of walls. Walls are gone. The tug-of-war of craving and fear pulls only because both ends are tied to the same vanished post.
...
If failure were likely, would the method ask you to watch the wave pass and find it pass? Or would it ask you to clench and count and white-knuckle nights?
...
“Your blood type needs it. Your brain needs it. Your will needs training.”
“One diet book says fruit is the same, so nothing matters.”
“One friend quit by strain and says you must strain too.”

Hear them as scripts, not as counsel. Each sentence lays one stick of wood back on sparks you starved. Each debate reopens a question seeing closed. You are not a student collecting views. You are an escapee walking grass. Debate is the cage calling.

The fact is you investigated with your own body and found the truth: bright want was installed, fear was installed with it, the machine warns to protect you, and freedom is clear, not grey. No outside talk changes what your afternoons proved. No slogan re-locks an open door.
...
```
REVISE
HEADER — draft places workshop header `IN THIS CHAPTER` after the title with list "Bright aisle at eye level. Cartoon friends..." before spoken body.
LENGTHEN to 5200±15% — Delivered 3852 words. Budget 5200. 0.85×5200=4420. 3852 < 4420.
MANTRA — card requires FT-D "the tug-of-war of craving and fear" verbatim; draft contains only capitalised "The tug-of-war of craving and fear", so token not present verbatim.
```
