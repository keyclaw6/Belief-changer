...
OUR CHAPTER path: /home/kab/quit-sugar-iter-022/loop/iterations/022/replicate-a/traces/chapter-03/response.md
THE REAL CHAPTER path: /home/kab/quit-sugar-iter-022/calibration/reference/gsbs/chapter-04.md
PREVIOUS CHAPTER path: /home/kab/quit-sugar-iter-022/loop/iterations/022/replicate-a/traces/chapter-02/response.md

Use this CHAPTER CONTEXT exactly (copied from the accepted plan card — do not improvise):

CHAPTER CONTEXT
Chapter 3 of 13 — CH-03 — What Does It Do FOR You
Primary job: NONE
Entering belief: NONE
Leaving belief: NONE
Arc and curve position: arc: first third to middle hinge | Freedom still low, Demolition axis set.; curve: NONE
Continuity: receives trapped-not-weak; hands empty benefit column to CH-04.
Assigned compliance:
- Instruction: NONE
- Mantras: M-D (echo): (unresolved); M-H (echo): (unresolved)
