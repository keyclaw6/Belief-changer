...
OUR CHAPTER path: /home/kab/Belief-changer/loop/iterations/049/quit-sugar/replicate-a/traces/chapter-04/response.md
THE REAL CHAPTER path: /home/kab/Belief-changer/calibration/reference/gsbs/chapter-08.md
PREVIOUS CHAPTER path: /home/kab/Belief-changer/loop/iterations/049/quit-sugar/replicate-a/traces/chapter-03/response.md

Use this CHAPTER CONTEXT exactly (copied from the accepted plan card — do not improvise):

CHAPTER CONTEXT
Chapter 4 of 15 — C04 — The energy lie
Primary job: enacted transition — the lift is seen as the start of the dip rather than genuine fuel
Entering belief: enters believing the sweet powers work; exits seeing the slump as bought by the earlier sweet
Leaving belief: enters believing the sweet powers work; exits seeing the slump as bought by the earlier sweet
Arc and curve position: arc: first demolition; cost language active; curve: NONE
Continuity: hands forward a reader who no longer credits the sweet for energy
Assigned compliance:
- Instruction: I-04: (unresolved)
- Mantras: M-D (debut): (unresolved); M-E (echo): (unresolved); M-G (echo): (unresolved)
