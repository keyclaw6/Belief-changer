...
IN THIS CHAPTER
Yesterday's wrappers spread on the table, the bathroom mirror in the morning, the till receipt in the pocket, the hand offered in the ditch
...
Money. Add the till. The small daily sums hide because they are small. Two here. One there. A meal deal sweetened. A large box because it was better value though it lasted two nights. Over a week the sum is not small. Over a year it is a holiday taken in wrappers. What did that money buy that stayed bought? Nothing stayed. Only the need to spend again.

Time. Add the minutes. The walk to the shop in the rain for something small. The queue. The drawer hunt. The standing minutes at the cupboard that never appear in any diary. The low minutes after, staring, scrolling, waiting to feel clear again. What did that time build? Nothing built. Only the need to spend again.
...
Follow the audit forward as it runs now, unchanged, for the rest of your life. The same small doses. The same brief lift. The same fast drop. The same rustle at night. The same mirror film. The same till slips. The same roller coaster you already tire of, ridden daily, paid daily, never arriving. If nothing changes in belief, that line runs on because one dose wakes the next and the belief calls the waking need.
