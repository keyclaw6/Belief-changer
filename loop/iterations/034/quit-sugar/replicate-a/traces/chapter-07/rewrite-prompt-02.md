...
I say this to steady you, not to frighten you. If you live with diabetes, take medicine that touches blood sugar or appetite, are pregnant, or carry medical risk around food, keep your clinician in charge and let this book stay belief work.
...
You do not have to believe that yet. You only have to observe it once, this evening, as a fact about your own body. Note the time it starts. Note what it names. Note that bread sounds dull to it. Note that plain food eaten hungry an hour later still satisfies while the tug promised only a packet could save you. Note that it passes without a bite. That single observation is worth a hundred promises.
...
The second creature is large. Call it the Sweet Con. It is the belief-system that feeds the Nibbler. It is the lifelong brainwashing that taught us to read the Nibbler's grumble as proof that BAD SUGAR is a genuine treat or fuel, as proof we need it to think, to work, to love, to rest.
...
Think of tight shoes loosened by the door after a long day. The ache all day, the sigh at taking them off, the sigh mistaken for pleasure in shoes. That sigh is the shape of every lift we praised.

Did the shoe give comfort? Or did the shoe give pain and then lend a pause from pain? Did we love the shoe? Or did we love the pause the shoe allowed?

Ask it about the dose. Did the hit give power? Or did the hit give a dip and then lend a brief climb out of the dip? Did we love the hit? Or did we love the brief quieting of a noise the hit had made?
...
It does plenty TO you. It never did a thing FOR the walker except pause the fall it caused.
...
Those were Nibbler grumbles passing unheard because the Con was busy elsewhere. They prove the echo can pass. They prove passing needs no strain, only inattention while life runs on.
...
This is where you are free to notice the call and smile while it thins. Not to fight it. Not to argue it down. To label it correctly as it fires.
...
Diet weeks taught the same lesson from the other side. Forbid by day, hunt by night. White-knuckle till Friday, empty the box on Saturday. The rule did not calm want. The rule scheduled it. The schedule is part of the trap form, not proof you are broken.
...
```
REVISE
LENGTHEN to B±15% — Delivered 4142 words. Budget 5000. Range 4250-5750. Add 110+ words to reach range serving the card job: "craving is a trivial dying Nibbler fed by a dominant Sweet Con belief; kill belief and body echo starves" — enacted as "early-evening grumble observed and relabelled — twitch noted, smiled at, passing without feed."
```
