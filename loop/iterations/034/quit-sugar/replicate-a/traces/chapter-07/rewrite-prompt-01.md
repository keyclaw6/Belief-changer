...
IN THIS CHAPTER
Evening kitchen at half past six with the twitch under the ribs. Two small creatures behind one loud voice. A ditch at dawn and a hand that offers help. Tight shoes by the door. Wrappers that call before any bite is taken.
...
You have eaten hungry and stopped at satisfied. You have felt bread hold you and soup steady you. And still the evening makes you hesitate.
...
Stay with it as it is, without feeding it and without fearing it, and watch its manners. Broad hunger, the one you met at the market table, opens wide and welcomes many plain things. This narrow tug arrives with drama and names one taste only. Bread sounds dull to it. Soup sounds wrong. Fruit sounds like a joke. Only a dose will do, it says, and only now.
...
When broad hunger is met with a plain meal, does it go quiet for hours? Yes. When this narrow tug is met with a sweet hit, does it go quiet for hours? No. It quiets for minutes, then returns louder, pickier, more urgent.
...
You do not have to believe that yet. You only have to observe it once, this evening, as a fact about your own body. Note the time it starts. Note what it names. Note that bread sounds dull to it. Note that it passes without a bite. That observation is worth a hundred promises.
...
And it is tiny. Mild but well-defined, small in scale, days-long, not a collapse. It peaks in a few days when daily hits stop, then passes. It never needed a clinic. It never needed a battle. It needed only to be left unfed while the mind stopped shouting.
...
Which cord keeps the lamp burning? The wire or the switch? Unplug the switch and the wire goes cold.

Think of tight shoes loosened at the door after a long day. The ache all day, the sigh at taking them off, the sigh mistaken for pleasure in shoes. That sigh is the shape of every lift we praised.
...
You know the answer because your afternoons gave it daily. Ten bright minutes borrowed against two fogged hours. Buzz, then flatness. Reach, then hunt. The lift made the low. The low called for the lift.
...
By the third week the walker waits for the hand. By the third month he praises it. What would I do without you, he says. You lift me every day. You are my support. He brings gifts. He defends the helper against all doubt. He fears the lane without the hand.
...
Was the hand cruel? No. The hand was a chemical hit doing what hits do. Was the walker foolish? No. He was conned by a sequence too quick to see. The villain is the pusher who hides the shove and shows only the help.
...
There is only one honest answer. The help is the harm paused.

See who profits and the picture sharpens. Not you. The makers who built the hit to spike fast and fade fast. The sellers who placed it at eye height, at checkout, in bright packs that call like voices. They never pushed you with hands. They pushed with light, colour, scent, placement, song. Then they sold you the hand as your own choice.

I am harsh on the pusher because the pusher earned it. I am warm to you because you never saw the shove. We all praised the hand. We all feared the lane without it. That fear belonged to the con, not to wisdom.

And here is the turn that makes this chapter different from a warning. You do not have to fight the hand. You do not have to climb by strain. You only have to see the shove. That is how you escape — by seeing who dug the ditch, not by hauling yourself out with torn nails.

A man who sees the trick stops waiting at the hedge. He walks the lane clear. He does not miss the hand. He pities the mornings he thanked it. He does not white-knuckle past the hedge holding his breath. He walks past smiling because the ditch is empty and the hand has no work.
...
On a plain day without hits, broad hunger opens gently and closes cleanly for hours when fed. On a dosing day, the narrow tug opens sharply and closes for minutes. Which one behaves like true need? True need, met, goes quiet. False need, met, comes back stronger.
...
We thought withdrawal would be unbearable because we added echo plus story and called the sum physical. Subtract the story and the remainder is bearable, brief, already fading. The unbearable part was never in the body. It was in the translation.
...
There is only one honest answer. The signs suggest because we taught them to suggest by pairing them with hits. Unpair them by living through them unfed and the suggestion fades.
...
Did restriction sharpen craving? Yes. Did intermittent rules — good all week, loose at weekend — drive bigger binges? Yes. Did ad-lib grazing without rules still leave the tug returning? Yes. Schedule plus hits drove the volume. That matches your diary without needing a laboratory.
...
LENGTHEN to B±15% — Delivered 3750 words. Budget 5000. Range 4250–5750. 3750 is below 0.85 × B. Add ~500–1000 words serving the card job: "craving is a trivial dying Nibbler fed by a dominant Sweet Con belief; kill belief and body echo starves."

HEADER — Draft opens with workshop header `IN THIS CHAPTER` block after the title. Remove it and open in spoken body.

MANTRA — Card-assigned M-C "the Sugar Trap" is not present verbatim anywhere in draft.

UNASSIGNED-REFRAIN — Non-mantra phrase "There is only one honest answer." recurs 3× verbatim. Keep one instance, subtract the other repeats; do not invent a new mantra.
```
