...
IN THIS CHAPTER
A full cupboard. A boxed line around BAD SUGAR. A house that lived the roller coaster. An eating contract. A combination lock.
...
```
REVISE
HEADER — draft opens with workshop header `IN THIS CHAPTER` plus list line "A full cupboard. A boxed line around BAD SUGAR. A house that lived the roller coaster. An eating contract. A combination lock." Delete that block; keep spoken body opening from "You are holding this book for a reason."
```
