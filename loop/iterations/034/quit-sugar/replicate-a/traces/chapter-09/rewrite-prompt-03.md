...
IN THIS CHAPTER — The dark cinema row, the same evening without the bar, two cups from one pot, the slow pot, the October birthday table, the deserve-and-comfort voices.
...
HEADER — draft opens with workshop header `IN THIS CHAPTER — The dark cinema row, the same evening without the bar, two cups from one pot, the slow pot, the October birthday table, the deserve-and-comfort voices.` Remove the header block entirely; open in spoken body.
```
