...
IN THIS CHAPTER — the plain table and the full ashtray, the yellow filter and the grey end, the spoken vow and the two knocks

*The last one gives nothing, and stubbing it with open eyes makes you a non-smoker on the spot.*
...
Watch the clock on any day you tracked. Smoke enters, drug reaches the brain in seconds, shoulders drop for a blink. That blink is real and brief. Within minutes the acute quiet thins and the edgy vacancy returns, exactly on time, asking for another coin. No problem moved while the coin dropped. The argument still sat on the desk. The page still sat unread. The music played whether paper burned or not. The people in the room went on talking while you stepped out to tap ash.

I know because I timed it with my own hand for years. I lit for calm and found the row unsolved after. I lit for focus and found the paragraph still unwritten. I lit for joy and found the joy in sun, leisure, company, none of which paper had lent. The soft quiet for a minute is relief from lack, not help with the bill on the table.

What follows a final dose is not torture for all. For most, the vacancy peaks in the first few days and thins within weeks; your hours may run a little earlier or later, not every body keeps the same clock. If you feel ill or worried, see your clinician. The tug is small, brief, already dying when unfed — an empty, slightly restless, slightly edgy little tug — not proof you need paper to be yourself. It is proof lack is complaining because it is not fed. Leave it unfed and it thins.
...
Look at the meter you fed all day. Each puff dropped a coin, the meter faded in minutes, you fed again. That is not pleasure. That is rental. A man who pays all day to stand still has not bought movement. He has bought the right to pay again. Stop dropping coins and the demand to drop them dies with the habit that made it.

It never fixed the itch. It caused it.

## THE VOW THAT MAKES YOU A NON-SMOKER

You have looked at the stain and the ash with open eyes. You have seen the clock and the coin. Now the seeing must be sealed with a spoken vow, made once and held by seeing.
...
```
REVISE
LENGTHEN to B±15% — Delivered 3211 words. Budget 4000. Range 3400-4600. 3211 is below 0.85×B. Add words serving the card job "smoker identity crosses to non-smoker in a joyful solemn act with freedom conferred now" — readiness gate, farewell-table seeing, vow and instant conferral.
HEADER — Draft opens with workshop header "IN THIS CHAPTER — the plain table and the full ashtray, the yellow filter and the grey end, the spoken vow and the two knocks" before spoken body.
```
