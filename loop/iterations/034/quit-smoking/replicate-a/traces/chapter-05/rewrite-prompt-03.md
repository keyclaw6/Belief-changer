...
We told ourselves the dose extends the pause. It shortens it. It fills the two minutes you had for eyes and breath with checking, finding, stepping, drawing, watching, stubbing, hiding. Half your mind is outside in the cold, half is on the next thing waiting inside. You return a little staler than the non-smoker who simply stood and breathed, and you call the staler fresher because a need went quiet inside it.

Think of the pause itself, apart from reward. Phone down. Kettle on. Two minutes with nothing to do. Papers waiting. Hands empty. The non-smoker stretches, looks out of the window, breathes, lets his eyes rest, and returns. Two minutes. Nothing taken. Nothing burned. The mind settles because pausing settles it.

The smoker spends the two minutes feeding a need. He checks the packet. He finds the lighter. He steps out or leans out. He watches the clock while he draws. He returns with a tighter chest and a drier mouth and calls that a break.

Did the pause settle you, or did the lighting end the gnaw left by the last dose, and call that ending settling?

A true pause leaves you fresher than before. This pause leaves you a little staler than before, a little tighter, a little more in need of the next pause. That is not rest. That is service dressed as rest.
...
Your pause was his pause before the trap taught you otherwise. It was yours before the first dose, and it never stopped being yours except in the story.
