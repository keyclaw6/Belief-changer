...
That year of trying answers itself. Double never caught it. Double buried it. The chase proves the dulling, not the delight.
...
Both ropes give the same answer. Neither rope is yours. This is the tug-of-war of craving and fear.
...
IN THIS CHAPTER
- The dark cinema row and the shared bar
- The same row an hour later with empty hands
- Two cups of tea under false names
- A pot warming degree by degree
- A birthday table told straight
