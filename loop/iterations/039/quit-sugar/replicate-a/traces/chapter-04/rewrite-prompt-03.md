...
IN THIS CHAPTER
Monday's ruled pages, one biscuit at half past nine, the boast by the kettle, the sigh in the till queue
...
"IN THIS CHAPTER / Monday's ruled pages, one biscuit at half past nine, the boast by the kettle, the sigh in the till queue"
Delete this inventory header entirely; open in-scene. The numbered command in-body is this card's assigned NEW instruction and is otherwise earned, so preserve it verbatim with number and imperative:
"4. NEVER BLAME YOURSELF AGAIN / Every failure was the method, never you."
earned by the immediately preceding diary reading "Once seen, that reading cannot be unseen... / Put Monday and Wednesday side by side and place the blame where your diary proves it belongs:" — retain that concrete lead-in, do not replace with generic rationale.
```
