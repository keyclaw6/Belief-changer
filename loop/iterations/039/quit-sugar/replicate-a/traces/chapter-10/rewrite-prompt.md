...
IN THIS CHAPTER
Friday calendar with one date circled, cliff edge at first light, biscuit box on the worktop, seatbelt clicked before a school run
...
Friday comes. You buy. You allow. First square sweet, second cloying, third furry, then hunt, then second bar, then cold cake over the sink, then morning fur. The box empty before the swallow ends. Saturday you say the rule slipped and promise next Friday will be cleaner. By Sunday night Thursday has already started again in the head.
