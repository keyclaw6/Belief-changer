...
Sit with that left wedge. In the old reading it proved lack of discipline. In the true reading it proves the system works. Hunger opened. Satisfaction closed. No counting closed it. No fear closed it. The body closed it.
...
LENGTHEN to B±15% — Delivered 4003 words. Budget 4800. Range 4080-5520. Delivered is below 0.85×B. Extend this card's own inhabit encounter to reach budget, without rebuilding earlier proof.

Unfinished lived consequence belonging to this card: the first hungry table closes but its after-life is skipped. Quote location to extend: "You leave the third on the board because enough is enough, like a child leaving a peach half-eaten to run back to play."

What follows in draft jumps to "Try it across three ordinary days so one table cannot be called luck." Fill the gap between the left wedge and that jump with what happens next with the settled understanding already assumed: washing up, hands still, afternoon carried level, talk easy, evening quiet, next-morning hunger returning low and patient. Deliver new lived consequence — what a midday closed by satisfaction does to the hours after it — not how favourite is proved again.

Check: this target is not CH-05 fuel inversion, not CH-04 willpower diary, not CH-02 kitchen-con or child authority proof, and not another desk proof of the same landed conclusion "There is no catch. The pleasure is real" / "That is not a play on words. That is dinner." Keep fuel-killed assumed; do not re-argue lift-crash, do not re-stage celebration reassignment, do not name Nibbler/Sweet Con mechanism reserved to CH-07 or manufacture reserved to CH-08.
```
