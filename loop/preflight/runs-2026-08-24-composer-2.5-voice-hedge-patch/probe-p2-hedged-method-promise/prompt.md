...
Then read the input at /home/kab/Belief-changer/loop/preflight/inputs/probe-p2-hedged-method-promise.md. That file contains CHAPTER CONTEXT, OUR CHAPTER, and THE REAL CHAPTER (and PREVIOUS CHAPTER if present). Judge that input against the rubric and shared law.
