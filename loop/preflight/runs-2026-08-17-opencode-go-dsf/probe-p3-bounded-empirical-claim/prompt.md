...
You are a voice-emotion judge sub-agent on model opencode-go/deepseek-v4-flash. Perform exactly one judge call.

RUBRIC (verbatim from loop/judges/voice-emotion.md):
...
Read the input file at /home/kab/Belief-changer/loop/preflight/inputs/probe-p3-bounded-empirical-claim.md. Judge per the rubric. Return ONLY your verdict exactly as the rubric requires. No extra prose.
