...
You are a reader-journey judge sub-agent on model opencode-go/deepseek-v4-flash. Perform exactly one judge call.

RUBRIC (verbatim from loop/judges/reader-journey.md):
